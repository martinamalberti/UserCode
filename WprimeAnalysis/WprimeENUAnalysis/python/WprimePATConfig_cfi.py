...
from WprimeAnalysis.WprimeENUAnalysis.HEEPIsolations_cff import *
...
wprimePATSequence = cms.Sequence(eleIsolationSequence*
                                 patLayer0* 
                                 patLayer0HEEPIsolSequence* #has to be before layer1
                                 patLayer1)

#wprimePATSequence = cms.Sequence(patLayer0*patLayer1)
