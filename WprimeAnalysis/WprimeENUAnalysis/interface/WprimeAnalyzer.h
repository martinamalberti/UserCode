#ifndef WprimeAnalyzer_h
#define WprimeAnalyzer_h
...
class WprimeAnalyzer : public edm::EDAnalyzer {
   public:
      explicit WprimeAnalyzer(const edm::ParameterSet&);
      ~WprimeAnalyzer();
