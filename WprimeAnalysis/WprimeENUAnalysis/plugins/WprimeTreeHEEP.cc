// -*- C++ -*-
//
// Package:   WprimeTreeHEEP
// Class:     WprimeTreeHEEP
//
 
#include "WprimeAnalysis/WprimeENUAnalysis/plugins/WprimeTreeHEEP.h"
...
WprimeTreeHEEP::WprimeTreeHEEP (const edm::ParameterSet& iConfig)
{
...
void WprimeTreeHEEP::analyze (const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  naiveId_++;
  ...
  if ( ! recHitsEB.isValid() ) {
    std::cerr << "WprimeTreeHEEP::analyze --> recHitsEB not found" << std::endl; 
  }
  ...
  dumpElectronInfo( electrons, theBarrelEcalRecHits, topology, myTreeVariables_) ;
...
void WprimeTreeHEEP::dumpElectronInfo ( View<pat::Electron> electrons,
...
// dump MET Info
void WprimeTreeHEEP::dumpMetInfo ( View<pat::MET>  mets ,
			       WprimeTreeContent & myTreeVariables_)
...
// dump JET Info
void WprimeTreeHEEP::dumpJetInfo ( View<pat::Jet>  jets ,
			       WprimeTreeContent & myTreeVariables_)
...
void WprimeTreeHEEP::dumpMuonInfo ( View<pat::Muon>  muons ,
			       WprimeTreeContent & myTreeVariables_)
...
// dump L1Info
void WprimeTreeHEEP::dumpL1Info ( edm::Handle<L1GlobalTriggerReadoutRecord>  gtRecord ,
			    WprimeTreeContent & myTreeVariables_)
{
...
// dump HLTInfo
void WprimeTreeHEEP::dumpHLTInfo ( Handle<TriggerResults>  hltresults ,
			       WprimeTreeContent & myTreeVariables_)
{
  edm::TriggerNames triggerNames_;
