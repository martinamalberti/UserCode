{
  ...
  TFile *f1 = TFile::Open("Graphs_EoP_vs_LocalPhi_Folded20_crackCorr.root");
  ...
  //TFile *f = TFile::Open("Graphs_EoP_vs_LocalPhi_Folded20_regression.root");
  TFile *f = TFile::Open("Graphs_EoP_vs_LocalPhi_Folded4_regression.root");
