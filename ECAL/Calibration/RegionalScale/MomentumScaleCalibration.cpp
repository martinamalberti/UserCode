// per compilare: g++ -Wall -o MomentumScaleCalibration `root-config --cflags --glibs` MomentumScaleCalibration.cpp
...
int main(int argc, char** argv)
{
  ...
  sprintf(outfilename,"outputFiles/momentumScale_vtx_min5_max100.root");
